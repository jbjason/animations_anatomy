...
final List<Trip> trips = [
  const Trip(
      ...
      price: '350',
      nights: '3',
      img: 'assets/trip/beach.png'),
  const Trip(
      title: 'City Break',
      price: '400',
      nights: '5',
      img: 'assets/trip/city.png'),
  const Trip(
      title: 'Ski Adventure',
      price: '750',
      nights: '2',
      img: 'assets/trip/ski.png'),
  const Trip(
      title: 'Space Blast',
      price: '600',
      nights: '4',
      img: 'assets/trip/space.png'),
  const Trip(
      title: 'Beach', price: '350', nights: '3', img: 'assets/trip/beach.png'),
  const Trip(
      title: 'City', price: '400', nights: '5', img: 'assets/trip/city.png'),
  const Trip(
      title: 'Ski', price: '750', nights: '2', img: 'assets/trip/ski.png'),
  const Trip(
